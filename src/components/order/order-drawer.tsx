...
const OrderDrawer: React.FC = () => {
  ...
  let { shipping_address, instruction } = data;
      ...
      {data !== '' && (
        <>
          <div className="p-8">
            ...
            {instruction && (
              <p className="text-skin-base opacity-70">Note: {instruction}</p>
            )}
            {/* <OrderStatus status={data?.status?.serial} /> */}
            <div className="mt-4 grid grid-cols-12 bg-skin-two py-3 rounded-[3px] text-black text-[12px] md:text-[14px]">
